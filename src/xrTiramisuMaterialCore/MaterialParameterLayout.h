...
[[nodiscard]] FMaterialParameterPackResult PackMaterialParameters(const FMaterialParameterLayout& Layout,
    xr_span<const FMaterialParameterDefinition> Definitions, const FMaterialParameterMap& Values);
