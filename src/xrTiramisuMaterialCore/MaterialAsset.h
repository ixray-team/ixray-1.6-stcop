...
private:
	bool ResolveRecursive(xr_string_view Reference, xr_vector<xr_string>& ActiveReferences, FResolvedMaterialInstance& Resolved, xr_vector<FMaterialDiagnostic>& Diagnostics) const;
