...
public:
    ...
    TiramisuMaterialInstanceDynamic(FMaterialAssetId InMaster, FMaterialParameterMap InRuntimeParameters,
        FMaterialStaticParameterSet InStaticParameters);
...
[[nodiscard]] FMaterialPermutationStatistics CalculateMaterialPermutationStatistics(
    xr_span<const FMaterialParameterDefinition> Parameters) noexcept;
