...
namespace
{
	...
	{
		FMaterialPassDefinition{MaterialPassManifestVersion, EMaterialPass::Depth, "depth", "materials/passes/MaterialDepthPass.hlsl", "Main", "ps_6_6", "level_static", "depth:d24s8"},
...
const FMaterialVertexFactoryDefinition* FindMaterialVertexFactoryDefinition(const xr_string_view Name) noexcept
{
...
FMaterialPipelineKey MakeCookedMaterialPipelineKey(const FResolvedMaterialInstance& Material, const FMaterialPassDefinition& Pass, const xr_string_view Backend)
{
