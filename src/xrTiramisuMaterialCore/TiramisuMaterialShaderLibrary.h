...
public:
    ...
    [[nodiscard]] xr_optional<FMaterialShaderProgramView> Find(
        const FMaterialAssetId& MaterialId, EMaterialPass Pass,
        xr_string_view VertexFactory, xr_string_view RenderPassSignature) const;
    [[nodiscard]] xr_optional<FMaterialShaderProgramView> Find(
        const FMaterialAssetId& MaterialId, u64 PipelineKey, EMaterialPass Pass,
        xr_string_view VertexFactory, xr_string_view RenderPassSignature) const;
