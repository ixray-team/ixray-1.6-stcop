...
Flags32		ps_r2_ls_flags				= { R2FLAG_SUN 
	...
	| R2FLAG_EXP_MT_CALC | RR3FLAG_DYN_WET_SURF
...
Flags32		ps_r2_ls_flags_ext			= {
		...
		|R2FLAGEXT_ENABLE_TESSELLATION | R2FLAGEXT_DOF_WEATHER
	};
...
public:
	...
	virtual void Execute(LPCSTR args) {
		...
		xrAPI.Render->Screenshot(IRender_interface::SM_NORMAL,image);
	}
};
...
void		xrRender_initconsole	()
{
	...
	CMD3(CCC_Integer, "r__optimize_shadow_geom", &OptShadowGeom, 0, 1);
...
//	CMD3(CCC_Mask,		"r2_sun_shafts",				&ps_r2_ls_flags,			R2FLAG_SUN_SHAFTS);
	...
	CMD3(CCC_Mask,		"r3_dynamic_wet_surfaces",		&ps_r2_ls_flags,			RR3FLAG_DYN_WET_SURF);
