...
#include "xrRenderOpenGL/dxUIShader.h"
...
BOOL r2_sun_static = FALSE;
BOOL r2_advanced_pp = TRUE;	//	advanced post process and effects
//////////////////////////////////////////////////////////////////////////
...
void CRender::OnFrame()
{
	...
	if (ps_r2_ls_flags.test(R2FLAG_EXP_MT_CALC))
	{
		// MT-details (@front)
		Device.seqParallel.insert(Device.seqParallel.begin(),
			fastdelegate::MakeDelegate(Details, &CDetailManager::MT_CALC));
...
static IC void load_includes(LPCSTR pSrcData, UINT SrcDataLen, xr_vector<char*>& source, xr_vector<char*>& includes)
{
