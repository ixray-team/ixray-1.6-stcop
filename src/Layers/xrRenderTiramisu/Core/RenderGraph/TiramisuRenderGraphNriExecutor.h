...
public:
	...
	[[nodiscard]] bool Initialize(nri::Device& Device, const nri::CoreInterface& CoreInterface, const FNriQueueBindings& Queues, u32 QueuedFrameCount, xr_string& Diagnostic);
	void Destroy();
