...
namespace Tiramisu
{
bool TiramisuDeferredDeletionQueue::Enqueue(const u64 RetireFence,
...
{
    const auto ReadyEnd = std::upper_bound(Entries.begin(), Entries.end(),
        CompletedFence, [](const u64 Fence, const FEntry& Entry)
        {
