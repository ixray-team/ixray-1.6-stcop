...
constexpr bool IsThreadRoleSatisfied(const EThreadRole Role, const bool RenderThreadRunning,
    const size_t CurrentThreadId, const size_t GameThreadId,
    const size_t RenderThreadId) noexcept
{
