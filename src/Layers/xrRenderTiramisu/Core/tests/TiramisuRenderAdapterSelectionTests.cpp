...
int main()
{
    ...
    const xr_array Incompatible = {
        FTiramisuAdapterCandidate{ApiMask(ETiramisuGraphicsApi::D3D12),
            ETiramisuAdapterKind::Discrete, 1, 8'000, 0},
        FTiramisuAdapterCandidate{ApiMask(ETiramisuGraphicsApi::Vulkan),
            ETiramisuAdapterKind::Discrete, 0, 16'000, 0}};
    ...
    const xr_array Candidates = {
        FTiramisuAdapterCandidate{ApiMask(ETiramisuGraphicsApi::Vulkan) |
                ApiMask(ETiramisuGraphicsApi::D3D12),
            ETiramisuAdapterKind::Integrated, 1, 32'000, 64'000},
        FTiramisuAdapterCandidate{ApiMask(ETiramisuGraphicsApi::Vulkan),
            ETiramisuAdapterKind::Discrete, 1, 8'000, 16'000},
        FTiramisuAdapterCandidate{ApiMask(ETiramisuGraphicsApi::D3D12),
            ETiramisuAdapterKind::Discrete, 1, 12'000, 8'000},
        FTiramisuAdapterCandidate{ApiMask(ETiramisuGraphicsApi::Vulkan),
            ETiramisuAdapterKind::Discrete, 1, 16'000, 8'000}};
    ...
    const xr_array StableTie = {
        FTiramisuAdapterCandidate{ApiMask(ETiramisuGraphicsApi::Vulkan),
            ETiramisuAdapterKind::Discrete, 1, 10'000, 5'000},
        FTiramisuAdapterCandidate{ApiMask(ETiramisuGraphicsApi::Vulkan),
            ETiramisuAdapterKind::Discrete, 1, 10'000, 5'000}};
    ...
    const xr_array QueueTie = {
        FTiramisuAdapterCandidate{ApiMask(ETiramisuGraphicsApi::Vulkan),
            ETiramisuAdapterKind::Discrete, 1, 10'000, 5'000, 0, 0},
        FTiramisuAdapterCandidate{ApiMask(ETiramisuGraphicsApi::Vulkan),
            ETiramisuAdapterKind::Discrete, 1, 10'000, 5'000, 1, 1}};
