...
int main()
{
    ...
    DELETE_CHECK(Queue.Enqueue(3, [&] { Deleted.push_back(30); }));
    DELETE_CHECK(Queue.Enqueue(1, [&] { Deleted.push_back(10); }));
    DELETE_CHECK(Queue.Enqueue(3, [&] { Deleted.push_back(31); }));
    ...
    DELETE_CHECK(Queue.Enqueue(9, [&] { Deleted.push_back(90); }));
    DELETE_CHECK(Queue.Enqueue(7, [&] { Deleted.push_back(70); }));
