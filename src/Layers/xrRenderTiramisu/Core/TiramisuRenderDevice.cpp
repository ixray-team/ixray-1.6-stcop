...
TiramisuRenderDevice::TiramisuRenderDevice()
	: CoreInterface({}), SwapChainInterface({}), HelperInterface({})
{
}

TiramisuRenderDevice::~TiramisuRenderDevice() = default;
...
)
{
	...
	R_ASSERT2(FindBestAdapterDescription(GraphicsApi, CurrentAdapterDescription), "Tiramisu could not find a compatible graphics adapter");
...
bool TiramisuRenderDevice::FindBestAdapterDescription(const nri::GraphicsAPI GraphicsApi, nri::AdapterDesc& Result)
{
