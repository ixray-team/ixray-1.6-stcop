...
TLegacyScene::~TLegacyScene()
{
	Clear();
}

void TLegacyScene::LoadLevel(IReader* FileReader)
{
	Clear();
...
TLegacySceneSector* TLegacyScene::GetSectorByRay(const Fvector& Position, const Fvector& Direction)
{
...
TLegacySceneSector* TLegacyScene::GetSector(Fvector Position)
{
...
void TLegacyScene::LoadSectors(IReader* Reader)
{
...
void TLegacyScene::LoadSWIs(CStreamReader* base_fs)
{
}
