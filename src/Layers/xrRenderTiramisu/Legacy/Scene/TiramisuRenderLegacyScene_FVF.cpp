...
EVertexType TiramisuLegacyScene::GetAndConvertFVF(CStreamReader* base_fs, u32& OutSize)
{
	...
	{
		constexpr s32 Offset = sizeof(LDeclR1LMap) - sizeof(TempArray);
	...
	{
		constexpr s32 Offset = sizeof(LDeclR1Vert) - sizeof(TempArray);
		base_fs->advance(Offset);
	...
	{
		constexpr s32 Offset = sizeof(LDeclMUModel) - sizeof(TempArray);
		base_fs->advance(Offset);
	...
	{
		constexpr s32 Offset = sizeof(LDeclXVert) - sizeof(TempArray);
		base_fs->advance(Offset);
