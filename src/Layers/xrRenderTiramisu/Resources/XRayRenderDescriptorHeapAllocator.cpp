...
XRayRenderDescriptorHeapAllocator::XRayRenderDescriptorHeapAllocator()
{
...
uint32_t XRayRenderDescriptorHeapAllocator::Alloc(nri::Descriptor* InDescriptor)
{
    uint32_t Index = 0;
...
void XRayRenderDescriptorHeapAllocator::Free(uint32_t Index)
{
    FreeIndexesForNextFrame.push_back(Index);
}

void XRayRenderDescriptorHeapAllocator::FlushNextFrame()
{
    FreeIndexes.append_range(FreeIndexesForNextFrame);
    FreeIndexesForNextFrame.clear();
}

void XRayRenderDescriptorHeapAllocator::UpdateDescriptorRanges()
{
