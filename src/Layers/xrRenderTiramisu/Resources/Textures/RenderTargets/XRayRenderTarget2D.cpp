#include "XRayRenderTarget2D.h"

XRayRenderTarget2D::XRayRenderTarget2D(uint32_t InWidth, uint32_t InHeight, nri::Format InRenderTargetFormat, nri::ClearValue InClearValue, const shared_str& InName):XRayTexture(InName)
{
...
XRayRenderTarget2D::~XRayRenderTarget2D()
{
...
void XRayRenderTarget2D::SetNewAccessLayoutStage(nri::TextureBarrierDesc& TextureBarrierDescription, nri::AccessLayoutStage AfterAccessLayoutStage)
{
