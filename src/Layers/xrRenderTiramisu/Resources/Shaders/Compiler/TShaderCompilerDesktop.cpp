#include "TShaderCompilerDesktop.h"
...
bool TShaderCompilerDesktop::CompileDX12(const TShaderDefinesContainer& Defines, EShaderType ShaderType, const xr_vector<xr_string>& IncludePaths, const char* SourceFileName, const char* ResultFileName, xr_string& OutMessage)
{
...
bool TShaderCompilerDesktop::CompileDX11(const TShaderDefinesContainer& Defines, EShaderType ShaderType, const xr_vector<xr_string>& IncludePaths, const char* SourceFileName, const char* ResultFileName, xr_string& OutMessage)
{
	NODEFAULT;
	return false;
}

bool TShaderCompilerDesktop::Compile(const TShaderDefinesContainer& Defines, EShaderType ShaderType, const xr_vector<xr_string>& IncludePaths, const char* SourceFileName, const char* ResultFileName, xr_string& OutMessage)
{
	switch (GraphicsAPI)
	{
...
void TShaderCompilerDesktop::ReadFile(const char* Name, xr_vector<char>& Data)
{
...
bool TShaderCompilerDesktop::FileExists(const char* name)
{
	return std::filesystem::exists(name);
}

TShaderCompilerDesktop::TShaderCompilerDesktop(nri::GraphicsAPI InGraphicsAPI, bool NeedCreateShaderPDB, bool DebugShader):TShaderCompilerBase(NeedCreateShaderPDB, DebugShader)
{
...
const char* TShaderCompilerDesktop::GetDirectionName()
{
	switch (GraphicsAPI)
	{
...
bool TShaderCompilerDesktop::CompileVK(const TShaderDefinesContainer& Defines, EShaderType ShaderType, const xr_vector<xr_string>& IncludePaths, const char* SourceFileName, const char* ResultFileName, xr_string& OutMessage)
{
	DXCInluder LIncluder(DxcLibrary.Get());
