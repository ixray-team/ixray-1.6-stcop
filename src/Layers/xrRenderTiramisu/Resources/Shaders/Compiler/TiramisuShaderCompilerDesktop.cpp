...
bool TiramisuShaderCompilerDesktop::CompileDX12(const TiramisuShaderDefinesContainer& Defines, EShaderType ShaderType, const xr_vector<xr_string>& IncludePaths, const char* SourceFileName, const char* ResultFileName, xr_string& OutMessage)
{
...
bool TiramisuShaderCompilerDesktop::CompileDX11(const TiramisuShaderDefinesContainer& Defines, EShaderType ShaderType, const xr_vector<xr_string>& IncludePaths, const char* SourceFileName, const char* ResultFileName, xr_string& OutMessage)
{
	NODEFAULT;
	return false;
}

bool TiramisuShaderCompilerDesktop::Compile(const TiramisuShaderDefinesContainer& Defines, EShaderType ShaderType, const xr_vector<xr_string>& IncludePaths, const char* SourceFileName, const char* ResultFileName, xr_string& OutMessage)
{
	switch (GraphicsAPI)
	{
...
void TiramisuShaderCompilerDesktop::ReadFile(const char* Name, xr_vector<char>& Data)
{
...
bool TiramisuShaderCompilerDesktop::FileExists(const char* name)
{
...
const char* TiramisuShaderCompilerDesktop::GetDirectionName()
{
	switch (GraphicsAPI)
	{
		case nri::GraphicsAPI::D3D11:
...
bool TiramisuShaderCompilerDesktop::CompileVK(const TiramisuShaderDefinesContainer& Defines, EShaderType ShaderType, const xr_vector<xr_string>& IncludePaths, const char* SourceFileName, const char* ResultFileName, xr_string& OutMessage)
{
	DXCInluder LIncluder(DxcLibrary.Get());
