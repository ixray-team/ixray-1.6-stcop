...
public:
    ...
    TiramisuRenderMaterialInstanceDynamic*                     CreateLegacyInstanceDynamic (const shared_str& InName,
                                                                                     const shared_str& ShaderName,
                                                                                     const xr_vector<shared_str>& TextureNames);
...
private:
    ...
    xr_map<FMaterialAssetId,
        FResolvedMaterialInstance>  SourceResolvedMaterials;
};
