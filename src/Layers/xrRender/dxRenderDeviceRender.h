...
public:
	...
	virtual void	SetCacheXform(Fmatrix &mView, Fmatrix &mProject, float JitterX, float JitterY);
	virtual void	SetCachePrevXform(Fmatrix &mView, Fmatrix &mProject, float JitterX, float JitterY);
