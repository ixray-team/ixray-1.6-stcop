...
enum
{
	...
	R2FLAG_TONEMAP				= (1<<4),
	R2FLAG_GLOBALMATERIAL		= (1<<5),
	R2FLAG_ZFILL				= (1<<6),
	R2FLAG_R1LIGHTS				= (1<<7),
	R2FLAG_SUN_IGNORE_PORTALS	= (1<<8),

	R2FLAG_EXP_SPLIT_SCENE					= (1<<9),
	R2FLAG_EXP_DONT_TEST_UNSHADOWED			= (1<<10),
	R2FLAG_EXP_DONT_TEST_SHADOWED			= (1<<11),

	R2FLAG_EXP_MT_CALC			= (1<<12),

	R2FLAG_SOFT_WATER			= (1<<13),	//	Igor: need restart
	R2FLAG_SOFT_PARTICLES		= (1<<14),	//	Igor: need restart
	R2FLAG_VOLUMETRIC_LIGHTS	= (1<<15),
	R2FLAG_STEEP_PARALLAX		= (1<<16),
	R2FLAG_DOF					= (1<<17),

	R1FLAG_DETAIL_TEXTURES		= (1<<18),
	R2FLAG_DETAIL_BUMP			= (1<<19),

	R3FLAG_DYN_WET_SURF			= (1<<20),
	R3FLAG_VOLUMETRIC_SMOKE		= (1<<21),
	R3FLAG_GBUFFER_OPT			= (1<<22)
};
