...
const		u32					SMAP_adapt_min = RImplementation.o.smapsize / 64		;	//GSC - 32. Now 2048 / 64 = 32, same for 2048 atlas size	
const		u32					SMAP_adapt_optimal	= RImplementation.o.smapsize / 4	;	//GSC - 768. Now 2048 / 4 = 512, seems legit fits 16 shadowmaps
const		u32					SMAP_adapt_max = RImplementation.o.smapsize / 2			;	//GSC - 1536. Now 2048 / 2 = 1024, seems legit fits 4 shadowmaps
