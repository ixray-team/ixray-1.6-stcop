...
void CKinematics::DebugRender(Fmatrix& XFORM)
{
	...
	for (u32 i=0; i<dbgLines.size(); i+=2)	{
		...
		DebugRenderHelper.dbg_DrawLINE(XFORM, P1, P2, color_xrgb(0, 255, 0));

		Fmatrix M;
		M.mul_43(XFORM,M2);
		DebugRenderHelper.dbg_DrawOBB(M, H1, color_xrgb(255, 255, 255));
		DebugRenderHelper.dbg_DrawOBB(M, H2, color_xrgb(255, 255, 255));
	}
#endif
	...
	for (u32 b=0; b<bones->size(); b++)
	{
		...
		DebugRenderHelper.dbg_DrawOBB(W, obb.m_halfsize, color_xrgb(0, 0, 255));
	}
}
#endif
