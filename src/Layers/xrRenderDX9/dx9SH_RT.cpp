...
void CRT::create(LPCSTR Name, u32 w, u32 h, ERHITextureFormat f, u32 SampleCount)
{
	...
	// DX11 style creation of super cool depth stencil view from ForserX (Oles to Dima: FIX )
	if (bUseAsDepth)
	{
		R_ASSERT(RHIUtils::CreateDepthStencilSurface(dwWidth, dwHeight, fmt, 0, 1, false, &pZRT, nullptr));
	}
}
