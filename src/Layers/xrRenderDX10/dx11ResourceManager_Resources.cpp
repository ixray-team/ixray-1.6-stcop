...
SGeometry*	CResourceManager::CreateGeom	(D3DVERTEXELEMENT9* decl, IVertexBuffer* vb, IIndexBuffer* ib)
{
	R_ASSERT			(decl && vb);
...
SGeometry*	CResourceManager::CreateGeom		(u32 FVF, IVertexBuffer* vb, IIndexBuffer* ib)
{
