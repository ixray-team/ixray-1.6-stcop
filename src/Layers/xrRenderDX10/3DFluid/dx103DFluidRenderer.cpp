...
void dx103DFluidRenderer::Destroy()
{
	...
	//createGridBox();
	m_GeomGridBox = 0;
	delete m_pGridBoxVertexBuffer;
	delete m_pGridBoxIndexBuffer;
...
void dx103DFluidRenderer::CreateGridBox () 
{
	...
	R_CHK(RHIUtils::CreateVertexBuffer(&m_pGridBoxVertexBuffer, vertices, sizeof(vertices)));
	...
	R_CHK(RHIUtils::CreateIndexBuffer	(&m_pGridBoxIndexBuffer, indices, sizeof(indices)));
...
void dx103DFluidRenderer::CreateScreenQuad() 
{
	...
	R_CHK(RHIUtils::CreateVertexBuffer(&m_pQuadVertexBuffer, svQuad, sizeof(svQuad)));
