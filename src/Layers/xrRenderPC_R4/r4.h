...
public:
	...
	xr_vector<IVertexBuffer*>									nVB,xVB;
	xr_vector<IIndexBuffer*>									nIB,xIB;
...
public:
	...
	IVertexBuffer*					getVB						(int id, BOOL	_alt=FALSE);
	IIndexBuffer*					getIB						(int id, BOOL	_alt=FALSE);
...
public:
	...
	virtual void					level_Unload				();
			...
			IBaseTexture*			texture_load					(LPCSTR	fname, u32& msize, bool bStaging = false);
			ID3DBaseTexture*		texture_load_old				(LPCSTR	fname, u32& msize, bool bStaging = false);
