...
#undef DisplayRT
	...
	// NORMAL
	{
		...
		rt_Normal.create(r2_RT_N, s_dwWidth, s_dwHeight, ERHI_FORMAT::R10G10B10A2_UNORM);

		rt_SurfaceTemp.create(r2_RT_S"_temp", s_dwWidth, s_dwHeight, ERHI_FORMAT::R8G8B8A8_UNORM);
		rt_NormalTemp.create(r2_RT_N"_temp", s_dwWidth, s_dwHeight, ERHI_FORMAT::R10G10B10A2_UNORM);
