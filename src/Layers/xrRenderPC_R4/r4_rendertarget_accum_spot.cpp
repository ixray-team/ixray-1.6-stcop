...
static Fvector4 ps_ssfx_volumetric = { 1.0f, 1.0f, 3.0f, 1.0f }; // Force Volumetric, Vol Intensity, Vol Quality
...
void CRenderTarget::accum_volumetric(light* L) {
	...
	RCache.set_ColorWriteEnable();
	GRHI->StateManager->SetCullMode(ERHI_CULLMODE::NONE);		// back
