...
//#include "EditMesh.h"
//#include "ui_main.h"
#include "../EditorProps/PropertiesListHelper.h"
#include "../EditorProps/ItemListHelper.h"
...
void CEditableObject::FillSummaryProps(LPCSTR pref, PropItemVec& items)
{
    ...
    sprintf(t.data(), "V: %d, F: %d", GetVertexCount(),GetFaceCount());
    ...
    for (EditMeshIt m_it=FirstMesh(); m_it!=LastMesh(); m_it++){
        ...
        sprintf(t.data(), "V: %d, F: %d",MESH->GetVertexCount(),MESH->GetFaceCount());
