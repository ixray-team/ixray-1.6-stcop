...
public:
	...
	void scale_map(u32* src_data, u32 src_width, u32 src_height, u32* dst_data, u32 dst_width, u32 dst_height, float sample_factor, XRay::Editor::CubeMap::pb_callback cb, void* pb_data)
	{
...
CCubeMapHelper cm;
void XRay::Editor::CubeMap::Simplify(u32* src_data, u32 src_width, u32 src_height, u32* dst_data, u32 dst_width, u32 dst_height, float sample_factor, pb_callback cb, void* pb_data)
{
