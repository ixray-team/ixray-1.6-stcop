...
void ESoundSource::FillProp(LPCSTR pref, PropItemVec& values)
{
	...
	V->OnChangeEvent.bind		(this,&ESoundSource::OnChangeSource);
	V=PHelper().CreateFloat		(values,PrepareKey(pref,"Source\\Min Distance"),	&m_Params.min_distance,		0.1f, 1000.f, 0.1f, 1);
	V->Owner()->Enable			(FALSE);
	V=PHelper().CreateFloat		(values,PrepareKey(pref,"Source\\Max Distance"),	&m_Params.max_distance,		0.1f, 1000.f, 0.1f, 1);
	V->Owner()->Enable			(FALSE);
	V=PHelper().CreateFloat		(values,PrepareKey(pref,"Source\\Max AI Distance"),	&m_Params.max_ai_distance,	0.1f, 1000.f, 0.1f, 1);
	V->Owner()->Enable			(FALSE);
