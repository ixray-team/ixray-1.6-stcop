...
struct IMGUI_API ImGuiDockNode
{
    ...
    bool                    IsFloatingNode() const  { return ParentNode == nullptr && (MergedFlags & ImGuiDockNodeFlags_DockSpace) == 0; }
...
struct ImGuiViewportP : public ImGuiViewport
{
    ...
    float               LastAlpha;
    bool                LastFocusedHadNavWindow;// Instead of maintaining a LastFocusedWindow (which may harder to correctly maintain), we merely store weither NavWindow != nullptr last time the viewport was focused.
