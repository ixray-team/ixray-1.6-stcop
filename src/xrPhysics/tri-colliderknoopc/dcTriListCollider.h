...
class dcTriListCollider
{
	...
	xr_vector<TriabgleCDBData>::iterator I,E,B;
public:
...
private:
	IC void VxToGlClTriState(u32 v);
	IC void SideToGlClTriState(u32 v0, u32 v1);
	template <class T>
...
IC void dcTriListCollider::VxToGlClTriState(u32 v)
{
	//CDB::TRI*       T_array      = Level().ObjectSpace.GetStaticTris();
	auto LI = I + 1;
	for (; E != LI; ++LI)
	{
		auto& verts = LI->GetTri().verts;
