...
namespace PAPI{
	...
	struct PARTICLES_API pDomain
	{
		...
		Fvector 	p1, p2;			// Box vertices, Sphere center, Cylinder/Cone ends
		Fvector 	u, v;			// Orthonormal basis vectors for Cylinder/Cone
		...
		pDomain& operator= (const pDomain& domain) = default;
	};
	#pragma pack (pop)
	// misc    
