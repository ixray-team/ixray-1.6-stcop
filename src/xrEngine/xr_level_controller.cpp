...
_keyboard keyboards[] = {
	...
	{ "kINTERNATIONAL1",        SDL_SCANCODE_INTERNATIONAL1 },
	{ "kINTERNATIONAL2",        SDL_SCANCODE_INTERNATIONAL2 },
	{ "kYEN",                   SDL_SCANCODE_INTERNATIONAL3 },
	{ "kINTERNATIONAL4",        SDL_SCANCODE_INTERNATIONAL4 },
	{ "kINTERNATIONAL5",        SDL_SCANCODE_INTERNATIONAL5 },
	{ "kINTERNATIONAL6",        SDL_SCANCODE_INTERNATIONAL6 },
	{ "kINTERNATIONAL7",        SDL_SCANCODE_INTERNATIONAL7 },
	{ "kINTERNATIONAL8",        SDL_SCANCODE_INTERNATIONAL8 },
	{ "kINTERNATIONAL9",        SDL_SCANCODE_INTERNATIONAL9 },
	...
	{ "kLANG6",                 SDL_SCANCODE_LANG6},
	{ "kLANG7",                 SDL_SCANCODE_LANG7 },
	{ "kLANG8",                 SDL_SCANCODE_LANG8},
	{ "kLANG9",                 SDL_SCANCODE_LANG9},
	...
	{ "kMEDIASELECT",           SDL_SCANCODE_MEDIASELECT },
	{ "kWWW",                   SDL_SCANCODE_WWW },
	{ "kMAIL",                  SDL_SCANCODE_MAIL },
	{ "kCALCULATOR",            SDL_SCANCODE_CALCULATOR },
	{ "kCOMPUTER",              SDL_SCANCODE_COMPUTER },
...
void initialize_bindings()
{
	...
	for (int idx = 0; idx < bindings_count; ++idx)
	{
		...
		for (int j = 0; keyboards[j].key_name != nullptr; ++j)
		{
			if (keyboards[j].dik == g_key_bindings[idx].m_action->id)
			{
				keyboards[j].key_local_name = g_pStringTable->translate(keyboards[j].key_name).c_str();
				break;
			}
		}
	}
...
void remap_keys()
{
	...
	while (keyboards[idx].key_name)
	{
		...
		kb.key_local_name = g_pStringTable->translate(kb.key_name).c_str();
