...
public:
	...
	IC	u64		GetElapsed_ms	()const	{	return u64(GetElapsed_ticks()*u64(1000)/CPU::qpc_freq );	}
...
public:
	...
	IC	double			GetElapsed_sec	() const
	{
#ifndef _EDITOR
		FPU::m64r		();
#endif        
		double			result = double(double(GetElapsed_ticks())/double(CPU::qpc_freq )	)	;
#ifndef _EDITOR
		FPU::m24r		();
#endif
		return			(result);
