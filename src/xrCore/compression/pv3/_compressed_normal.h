...
extern XRCORE_API float pvUVAdjustment[0x2000];

ICF void pvInitializeStatics()
{
...
ICF u16 pvCompress(const Fvector& vec)
{
	// save copy
	Fvector tmp = vec;
...
ICF void pvDecompress(Fvector& vec, u16 mVec)
{
