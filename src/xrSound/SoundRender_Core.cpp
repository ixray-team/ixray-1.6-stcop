...
float psSoundVelocityAlpha = 0.05f;
...
void CSoundRender_Core::set_listener(const CSoundRender_Environment& env)
{
...
void CSoundRender_Core::get_listener(CSoundRender_Environment& env)
{
