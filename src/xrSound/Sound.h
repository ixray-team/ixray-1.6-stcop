...
IC void	ref_sound::create						( LPCSTR name, esound_type sound_type, int	game_type)	{	 		::Sound->create		(*this,name,sound_type,game_type);							}
IC void	ref_sound::attach_tail					( LPCSTR name)											{	 		::Sound->attach_tail(*this,name);							}
