...
protected:
	...
	// pull power relative to current delta time, for FPS-agnostic damage/impulse
	virtual float	GetPullDeltaPower() { return (m_iStateTime - m_iPreviousStateTime) / 1000.f; }
...
protected:
	...
	//сила импульса вт€гивани€ в зону дл€ машин
	float			m_fThrowInImpulseCar;
	//коэфф. зат€гивани€ (чем меньше, тем плавнее зат€гивает)
	float			m_fThrowInAtten;
	//коэфф. хита при зат€гивании живых существ (домножаетс€ на основной хит выбрасывани€)
	float			m_fThrowInHitKoefAlive;
	//коэфф. хита при зат€гивании машин
	float			m_fThrowInHitKoefCar;
