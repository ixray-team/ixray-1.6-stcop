...
//////////////////////////////////////////////////////////////////////////
#define PREFETCHED_ARTEFACTS_NUM 1	//êîëè÷åñòâî ïðåäâàðèòåëüíî ïðîñïàâíåíûõ àðòåôàêòîâ
...
//////////////////////////////////////////////////////////////////////////
	...
	//çàãðóçèòü ïàðàìåòðû äëÿ ðàçáðàñûâàíèÿ àðòåôàêòîâ
...
void CCustomZone::UpdateWorkload	(u32 dt)
{
	...
	//âû÷èñëèòü âðåìÿ ñðàáàòûâàíèÿ çîíû
	...
	for(it = m_ObjectInfoMap.begin(); m_ObjectInfoMap.end() != it; ++it) 
	{
		if (!(*it).object->getDestroy()){
			...
			if (EA)
			{
				...
				if (EA->g_Alive()){
					// Çàíåñåì ìîíñòðà â ñïèñîê, åñëè åãî òàì åùå íåò
					bool found = false;
					...
					// Îò÷èñòèì ñïèñîê åñëè ìîíñòð â ñïèñîêå è îí ìåðòâ, ðåçðåøèì ñïàâí àðòà
					bool found = false;
					for (int i = 0; i < affectedgameobjects.size(); ++i)
					{
						if (EA == affectedgameobjects[i]) {
...
{
	//âû÷èñëèòü ñîãëàñíî ðàñïðåäåëåíèþ âåðîÿòíîñòåé
	//êàêîé àðòåôàêò èç ñïèñêà ñòàâèòü
