...
//				u_EventSend(P);
	...
	case kCAM_1:{	cam_Set(eacFirstEye);	CCustomDetectorR * detectortoshow = inventory().CurrentDetector();	if (detectortoshow)g_player_hud->attach_item(detectortoshow); }break; //ƒл€ востановлени€ детектора в руке
