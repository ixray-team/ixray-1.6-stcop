...
IC	CTradeActionParameters::CTradeActionParameters				(const CTradeFactors &default_factors, bool default_disabled)
{
	m_default			= default_factors;
	m_default_disabled   = default_disabled;
}
...
IC bool CTradeActionParameters::default_disabled() const
{
	return m_default_disabled;
}

IC void CTradeActionParameters::default_disabled(bool flag)
{
	m_default_disabled = flag;
}
