...
BOOL CInventoryOwner::net_Spawn		(CSE_Abstract* DC)
{
	...
	{
		CharacterInfo().m_SpecificCharacter.LoadSCharacter			("mp_actor");
...
{
#pragma todo("this code supports the infoportion dependancy, but the variable CanUpgrade() returns only true or false. We can change it in specific_character->load_shared")
