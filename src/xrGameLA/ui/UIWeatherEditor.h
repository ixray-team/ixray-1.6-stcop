...
public:
	...
	//Âûâåñòè â ëîã çíà÷åíèÿ ïàðàìåòðîâ
	virtual void			PrintToLog();

	virtual void			InitVars();
	//Îáíîâèòü ïîçèöèè ïîëîñîê
	...
	//Âîçìîæíîñòü âðåìåííîãî ñîõðàíåíèÿ ïàðàìåòðîâ
	struct SavedData{
		bool is_empty;
	...
	//Äåôîëòíûå çíà÷åíèÿ ïðè çàïóñêå
	SavedData DefaultParams;
	//Ñîõðàíåíûå çíà÷åíèÿ ðàçðàáîò÷èêîì
	SavedData UserSavedParams;

	//Ñîõðàíåíèòü çíà÷åíèÿ
