...
public:	
	...
	virtual void					spawn_supplies();
			void					spawn_supplies(CSE_ALifeDynamicObject*, const SSpecificCharacterSupplies&);
			void					spawn_supplies(CSE_ALifeDynamicObject*, const SSpecificCharacterSupplies::ITEMS&, const SSpecificCharacterSupplies::TEMPLATES&);
			void					SpawnItem(CSE_ALifeDynamicObject*, const SSpecificCharacterSupplies::Item&);
			void					SpawnTemplate(CSE_ALifeDynamicObject*, const SSpecificCharacterSupplies::TemplateRef&);
#endif
