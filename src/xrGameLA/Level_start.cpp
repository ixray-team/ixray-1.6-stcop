...
BOOL CLevel::net_Start	( LPCSTR op_server, LPCSTR op_client )
{
	...
	if (!loading_save_timer_started) loading_save_timer.Start();//if game also did prefetching, than dont start timer again, since it was started in prefetching stage
