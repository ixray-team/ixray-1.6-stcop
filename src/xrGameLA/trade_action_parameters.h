...
public:
	IC						CTradeActionParameters	(const CTradeFactors &default_factors = CTradeFactors(), bool default_disabled = false);
	IC	void				clear					();
	...
	IC	bool				default_disabled		() const;
	IC	void				default_disabled		(bool);
};
