...
public:
	IC					CObjectActionBase	(_item_type *item, CAI_Stalker *owner, CPropertyStorage *storage, const char* action_name = "");
...
public:
	IC					CObjectActionMember	(_item_type *item, CAI_Stalker *owner, CPropertyStorage *storage, u32 condition_id, _value_type value, const char* action_name = "");
...
public:
						CObjectActionCommand(CInventoryItem *item, CAI_Stalker *owner, CPropertyStorage *storage, u32 command, const char* action_name = "");
	virtual void		initialize			();
};
...
public:
						CObjectActionShow	(CInventoryItem *item, CAI_Stalker *owner, CPropertyStorage *storage, const char* action_name = "");
	virtual void		initialize			();
	virtual void		execute				();
};
...
public:
						CObjectActionHide	(CInventoryItem *item, CAI_Stalker *owner, CPropertyStorage *storage, const char* action_name = "");
	virtual void		execute				();
...
public:
						CObjectActionReload	(CInventoryItem *item, CAI_Stalker *owner, CPropertyStorage *storage, u32 type, const char* action_name = "");
	virtual void		initialize			();
	virtual void		execute				();
};
...
public:
						CObjectActionFire	(CInventoryItem *item, CAI_Stalker *owner, CPropertyStorage *storage, u32 type, const char* action_name = "");
	virtual void		initialize			();
	virtual void		execute				();
	virtual void		finalize			();
};
...
public:
						CObjectActionFireNoReload	(CInventoryItem *item, CAI_Stalker *owner, CPropertyStorage *storage, u32 type, const char* action_name = "");
	virtual void		initialize					();
	virtual void		execute						();
	virtual void		finalize					();
};
...
public:
						CObjectActionStrapping	(CInventoryItem *item, CAI_Stalker *owner, CPropertyStorage *storage, const char* action_name = "");
...
public:
						CObjectActionStrappingToIdle	(CInventoryItem *item, CAI_Stalker *owner, CPropertyStorage *storage, const char* action_name = "");
...
public:
						CObjectActionUnstrapping	(CInventoryItem *item, CAI_Stalker *owner, CPropertyStorage *storage, const char* action_name = "");
...
public:
						CObjectActionUnstrappingToIdle	(CInventoryItem *item, CAI_Stalker *owner, CPropertyStorage *storage, const char* action_name = "");
...
public:
						CObjectActionQueueWait	(CInventoryItem *item, CAI_Stalker *owner, CPropertyStorage *storage, u32 type, const char* action_name = "");
	virtual void		initialize				();
	virtual void		execute					();
	virtual void		finalize				();
};
...
public:
						CObjectActionSwitch	(CInventoryItem *item, CAI_Stalker *owner, CPropertyStorage *storage, u32 type, const char* action_name = "");
	virtual void		initialize			();
	virtual void		execute				();
	virtual void		finalize			();
};
...
public:
						CObjectActionDrop	(CInventoryItem *item, CAI_Stalker *owner, CPropertyStorage *storage, const char* action_name = "");
	virtual void		initialize			();
};
...
public:
						CObjectActionAim		(CInventoryItem *item, CAI_Stalker *owner, CPropertyStorage *storage, u32 condition_id, _value_type value, const char* action_name = "");
	virtual void		initialize				();
	virtual void		execute					();
	virtual void		finalize			();
};
...
public:
						CObjectActionIdle		(CInventoryItem *item, CAI_Stalker *owner, CPropertyStorage *storage, const char* action_name = "");
	virtual void		initialize				();
};
...
public:
						CObjectActionIdleMissile(CInventoryItem *item, CAI_Stalker *owner, CPropertyStorage *storage, const char* action_name = "");
	virtual void		initialize				();
};
...
public:
						CObjectActionThrowMissile	(CInventoryItem *item, CAI_Stalker *owner, CPropertyStorage *storage, const char* action_name = "");
	virtual void		initialize				();
	virtual void		execute					();
};
