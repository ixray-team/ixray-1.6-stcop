...
CCoverManager::Cover const *CCoverManager::add_smart_cover	(const char* table_name, smart_cover::object const &object, bool const &is_combat_cover, bool const &can_fire, luabind::object const &loopholes) const
{
	Cover					*smart_cover = 
		new Cover(
			object,
