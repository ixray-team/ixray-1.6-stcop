...
public:
	...
	u16		add_update			(ALife::_OBJECT_ID entity_id, NET_Packet const & update);
	u16		get_last_equpdates	(ALife::_OBJECT_ID entity_id, NET_Packet const & update);
private:
	last_update_t*	search_entity		(ALife::_OBJECT_ID entity_id);
...
public:
	...
	void	begin_updates		();
	void	write_update_for	(ALife::_OBJECT_ID enity, NET_Packet & update);
