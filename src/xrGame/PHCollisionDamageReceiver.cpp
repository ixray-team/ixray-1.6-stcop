...
void CPHCollisionDamageReceiver::Init()
{
	...
	IKinematics* K = PKinematics(sh->Visual());
...
void CPHCollisionDamageReceiver::CollisionHit(ALife::_OBJECT_ID source_id,u16 bone_id,float power,const Fvector& dir,Fvector &pos )
{
