...
{
    this->add_state(eStateControlled_Follow_Wait, new CStateMonsterCustomAction(obj));
    this->add_state(eStateControlled_Follow_WalkToObject, new CStateMonsterMoveToPointEx(obj));
}
