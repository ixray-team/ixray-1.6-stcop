...
{
    add_state(eStateControlled_Follow_Wait, new CStateMonsterCustomAction(obj));
    add_state(eStateControlled_Follow_WalkToObject, new CStateMonsterMoveToPointEx(obj));
}
