...
{
    add_state(eStateRest_WalkToCover, new CStateMonsterMoveToPointEx(obj));
    add_state(eStateRest_LookOpenPlace, new CStateMonsterLookToPoint(obj));
    add_state(eStateRest_Idle, new CStateMonsterCustomAction(obj));
}
