...
{
    add_state(eStateSquad_RestFollow_Idle, new CStateMonsterCustomAction(obj));
    add_state(eStateSquad_RestFollow_WalkToPoint, new CStateMonsterMoveToPointEx(obj));
}
