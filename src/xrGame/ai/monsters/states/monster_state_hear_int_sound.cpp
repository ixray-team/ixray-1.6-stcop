...
{
    add_state(eStateHearInterestingSound_MoveToDest, new CStateMonsterMoveToPoint(obj));
    add_state(eStateHearInterestingSound_LookAround, new CStateMonsterCustomActionLook(obj));
}
