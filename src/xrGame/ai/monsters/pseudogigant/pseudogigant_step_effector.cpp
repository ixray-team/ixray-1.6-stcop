...
CPseudoGiantBaseStepEffector::CPseudoGiantBaseStepEffector(float time, float amp, float periods, float power)
...
CPseudoGiantBaseStepEffector::~CPseudoGiantBaseStepEffector()
{

}

BOOL CPseudoGiantBaseStepEffector::ProcessCam(SCamEffectorInfo& info)
{
