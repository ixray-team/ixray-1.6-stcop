...
#define CStateBloodsuckerVampireHideAbstract CStateBloodsuckerIXVampireHide<_Object>

TEMPLATE_SPECIALIZATION
CStateBloodsuckerVampireHideAbstract::CStateBloodsuckerIXVampireHide(_Object* obj) : inherited(obj)
{
    this->add_state(eStateVampire_RunAway, new CStateMonsterHideFromPoint<_Object>(obj));
    this->add_state(eStatePredator, new CStateBloodsuckerIXPredator<_Object>(obj));
}
