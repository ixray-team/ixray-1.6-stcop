...
#define CStateBloodsuckerVampireExecuteAbstract CStateBloodsuckerIXVampireExecute<_Object>
...
void CStateBloodsuckerVampireExecuteAbstract::execute_vampire_prepare()
{
    ...
    this->object->sound().play(CAI_BloodsuckerIX::eVampireGrasp);
}
...
void CStateBloodsuckerVampireExecuteAbstract::execute_vampire_continue()
{
    ...
    this->object->sound().play(CAI_BloodsuckerIX::eVampireSucking);
...
void CStateBloodsuckerVampireExecuteAbstract::execute_vampire_hit()
{
    ...
    this->object->sound().play(CAI_BloodsuckerIX::eVampireHit);
