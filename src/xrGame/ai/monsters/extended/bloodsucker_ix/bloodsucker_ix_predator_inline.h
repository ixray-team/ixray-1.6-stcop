...
#define CStateBloodsuckerIXPredatorAbstract CStateBloodsuckerIXPredator<_Object>

TEMPLATE_SPECIALIZATION
CStateBloodsuckerIXPredatorAbstract::CStateBloodsuckerIXPredator(_Object* obj) : inherited(obj)
{
...
TEMPLATE_SPECIALIZATION
void CStateBloodsuckerIXPredatorAbstract::reinit()
{
	inherited::reinit	();
}

TEMPLATE_SPECIALIZATION
void CStateBloodsuckerIXPredatorAbstract::initialize()
{
...
TEMPLATE_SPECIALIZATION
void CStateBloodsuckerIXPredatorAbstract::reselect_state()
{
...
TEMPLATE_SPECIALIZATION
void CStateBloodsuckerIXPredatorAbstract::finalize()
{
	inherited::finalize();
...
TEMPLATE_SPECIALIZATION
void CStateBloodsuckerIXPredatorAbstract::critical_finalize()
{
...
TEMPLATE_SPECIALIZATION
bool CStateBloodsuckerIXPredatorAbstract::check_start_conditions()
{
...
TEMPLATE_SPECIALIZATION
bool CStateBloodsuckerIXPredatorAbstract::check_completion()
{
...
TEMPLATE_SPECIALIZATION
void CStateBloodsuckerIXPredatorAbstract::setup_substates()
{
...
TEMPLATE_SPECIALIZATION
void CStateBloodsuckerIXPredatorAbstract::check_force_state()
{
...
TEMPLATE_SPECIALIZATION
void CStateBloodsuckerIXPredatorAbstract::select_camp_point()
{
	m_target_node = u32(-1);
...
#undef CStateBloodsuckerIXPredatorAbstract
