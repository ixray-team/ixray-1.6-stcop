...
#define CBloodsuckerIXStateAttackHideAbstract CBloodsuckerIXStateAttackHide<_Object>

TEMPLATE_SPECIALIZATION
CBloodsuckerIXStateAttackHideAbstract::CBloodsuckerIXStateAttackHide(_Object* obj) : inherited(obj)
{
	add_state(eStateAttack_HideInCover, new CStateMonsterMoveToPointEx<_Object>(obj));
	add_state(eStateAttack_CampInCover, new CStateBloodsuckerIXPredatorLite<_Object>(obj));
}

TEMPLATE_SPECIALIZATION
void CBloodsuckerIXStateAttackHideAbstract::reinit()
{
	inherited::reinit();
}

TEMPLATE_SPECIALIZATION
void CBloodsuckerIXStateAttackHideAbstract::initialize()
{
...
TEMPLATE_SPECIALIZATION
void CBloodsuckerIXStateAttackHideAbstract::reselect_state()
{
...
TEMPLATE_SPECIALIZATION
void CBloodsuckerIXStateAttackHideAbstract::finalize()
{
	inherited::finalize();
...
TEMPLATE_SPECIALIZATION
void CBloodsuckerIXStateAttackHideAbstract::critical_finalize()
{
...
TEMPLATE_SPECIALIZATION
bool CBloodsuckerIXStateAttackHideAbstract::check_completion()
{
...
TEMPLATE_SPECIALIZATION
void CBloodsuckerIXStateAttackHideAbstract::setup_substates()
{
...
TEMPLATE_SPECIALIZATION
void CBloodsuckerIXStateAttackHideAbstract::check_force_state()
{
}

TEMPLATE_SPECIALIZATION
void CBloodsuckerIXStateAttackHideAbstract::select_camp_point()
{
	if (m_target_node != u32(-1))
		monster_squad().get_squad(object)->unlock_cover(m_target_node);
...
#undef CBloodsuckerIXStateAttackHideAbstract
