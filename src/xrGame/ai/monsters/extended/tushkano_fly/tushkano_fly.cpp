...
CTushkanoFly::CTushkanoFly()
{
	StateMan = new CStateManagerTushkanoFly(this);
...
void CTushkanoFly::Load(LPCSTR section)
{
...
void CTushkanoFly::CheckSpecParams(u32 spec_params)
{
