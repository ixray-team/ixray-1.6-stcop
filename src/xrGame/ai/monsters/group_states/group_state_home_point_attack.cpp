...
CStateGroupAttackMoveToHomePoint::CStateGroupAttackMoveToHomePoint(CBaseMonster* object) : inherited(object)
{
	add_state(eStateAttack_HomePoint_Hide, new CStateMonsterMoveToPointEx(object));
	add_state(eStateAttack_HomePoint_LookOpenPlace, new CStateMonsterLookToPoint(object));

	m_last_tick_enemy_inaccessible = 0;
	m_first_tick_enemy_inaccessible = 0;
}

CStateGroupAttackMoveToHomePoint::~CStateGroupAttackMoveToHomePoint()
{
}
