...
CStateGroupHearDangerousSound::CStateGroupHearDangerousSound(CBaseMonster* object) : inherited(object)
{
	...
	add_state(eStateHearDangerousSound_Hide, new CStateMonsterMoveToPointEx (object));
	add_state(eStateSquad, new CStateMonsterMoveToPoint (object));
	add_state(eStateHearDangerousSound_Home, new CStateMonsterDangerMoveToHomePoint (object));
}

CStateGroupHearDangerousSound::~CStateGroupHearDangerousSound()
{
