...
CStateGroupAttack::CStateGroupAttack(CBaseMonster* obj) : inherited(obj)
{
	this->add_state(eStateAttack_Run, xr_new<CStateGroupAttackRun>(obj));
	...
	this->add_state(eStateCustom, xr_new<CStateGroupSquadMoveToRadius>(obj));
	this->add_state(eStateAttack_AttackHidden, xr_new<CStateGroupSquadMoveToRadius>(obj));
	this->add_state(eStateAttackCamp, xr_new<CStateGroupSquadMoveToRadius>(obj));
	this->add_state(eStateAttack_Steal, xr_new<CStateGroupSquadMoveToRadiusEx>(obj));
	this->add_state(eStateAttack_ControlFire, xr_new<CStateCustomGroup>(obj));
}
