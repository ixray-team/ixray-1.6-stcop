...
void CPatrolPathParams::script_register(lua_State *L)
{
	...
	[
		class_<CPatrolPathParams>("patrol")
			...
			.def(								constructor<const char*,const PatrolPathManager::EPatrolStartType>())
			.def(								constructor<const char*,const PatrolPathManager::EPatrolStartType,const PatrolPathManager::EPatrolRouteType>())
			.def(								constructor<const char*,const PatrolPathManager::EPatrolStartType,const PatrolPathManager::EPatrolRouteType, bool>())
			.def(								constructor<const char*,const PatrolPathManager::EPatrolStartType,const PatrolPathManager::EPatrolRouteType, bool, u32>())
