...
{
	TALK_CONTACT_DATA():id(ALife::INVALID_OBJECT_ID),time(0){};
	TALK_CONTACT_DATA(ALife::_OBJECT_ID contact_id, ALife::_TIME_ID contact_time):id(contact_id),time(contact_time){};
	//время контакта
	ALife::_TIME_ID	time;
