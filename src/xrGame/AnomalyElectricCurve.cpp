...
void TAnomalyElectricCurve::Load(const char* section)
{
	...
	if (!options_section.empty())
	{
		...
		if (m_use_electric_curve)
		{
			draw_dbg = READ_IF_EXISTS(pSettings, r_bool, sect, "draw_debug", false); // �������
			...
			m_max_curve_radius = READ_IF_EXISTS(pSettings, r_float, sect, "max_curve_atack_radius", m_max_curve_radius);// ��� ����
			...
			m_cascade_curves = READ_IF_EXISTS(pSettings, r_bool, sect, "use_cascade_electric_curves", m_cascade_curves); // ������ ������
			if (m_cascade_curves)
			{
				m_touch_objects_by_curves = READ_IF_EXISTS(pSettings, r_bool, sect, "use_touch_objects_by_curves", m_touch_objects_by_curves); // ������ ������� ������� �� ��������
			}
