...
void CActionBase<CScriptGameObject>::script_register(lua_State *L)
{
	...
	[
		class_<CScriptActionBase, CScriptActionWrapper>("action_base")
			...
			.def("remove_precondition",			(void (CScriptActionBase::*)(const u32 &))(&CScriptActionBase::remove_condition))
			.def("remove_effect",				(void (CScriptActionBase::*)(const u32 &))(&CScriptActionBase::remove_effect))
