...
void xrServer::Perform_destroy(CSE_Abstract* object, u32 mode)
{
	...
	while (!object->children.empty())
	{
		...
		// Р•СЃР»Рё РґРѕС‡РµСЂРЅРёР№ РѕР±СЉРµРєС‚ РЅРµ РЅР°Р№РґРµРЅ, С‚Рѕ РјС‹ СѓР¶Рµ С„РёРі РїРѕР»СѓС‡РёРј РёРЅС„Сѓ Рѕ РЅС‘Рј, РЅРѕ С…РѕС‚СЏ Р±С‹ РµСЃС‚СЊ РёРЅС„Р° Рѕ СЂРѕРґРёС‚РµР»Рµ 
