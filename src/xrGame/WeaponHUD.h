...
class CWeaponHUD
{
	...
	float				m_fZoomRotateX = 0.0f;
	float				m_fZoomRotateY = 0.0f;
...
public: 
	...
	// Animations
	u32					animPlay		(MotionID M, BOOL bMixIn/*=TRUE*/, CHudItem*  W /*=0*/, u32 state, const CMotionDef*& md);
...
#define		MAX_ANIM_COUNT_WEAPON							8
