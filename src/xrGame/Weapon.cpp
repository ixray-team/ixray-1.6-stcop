...
//	m_zoom_params.m_bZoomDofEnabled	= !def_dof.similar(m_zoom_params.m_ZoomDof);
	...
	ControllerCanSwitchGL = pSettings->read_if_exists<bool>(hud_sect, "controller_can_switch_gl", ControllerCanSwitchGL);
	ControllerCanShootGL = pSettings->read_if_exists<bool>(hud_sect, "controller_can_shoot_gl", ControllerCanShootGL);
	SuicideByAnimation = pSettings->read_if_exists<bool>(hud_sect, "suicide_by_animation", SuicideByAnimation);
	...
	DisableLastAmmoMisfire = pSettings->read_if_exists<bool>(section, "disable_last_ammo_misfire", false);
	DisableEmptyFiremode = pSettings->read_if_exists<bool>(section, "disable_empty_firemode", false);
	DisableGrenadeChange = pSettings->read_if_exists<bool>(section, "disable_grenade_change", false);
