...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	RestoreFromJSONLambda("Host", GLoginInfo.Host);
	RestoreFromJSONLambda("Login", GLoginInfo.Login);
	RestoreFromJSONLambda("Password", GLoginInfo.Pass);

	string_path Config;

	SDL_Application();

	JSONData["Host"] = GLoginInfo.Host;
	JSONData["Login"] = GLoginInfo.Login;
	JSONData["Password"] = GLoginInfo.Pass;
