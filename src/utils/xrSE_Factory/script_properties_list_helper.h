...
public:
			...
			ChooseValue*		CreateChoose	    (PropItemVec* items, const char* key, luabind::object object, const char* name, u32 mode, const char* path);
			ChooseValue*		CreateChoose	    (PropItemVec* items, const char* key, luabind::object object, const char* name, u32 mode, const char* path, const char* fill_param);
			ChooseValue*		CreateChoose	    (PropItemVec* items, const char* key, luabind::object object, const char* name, u32 mode, const char* path, const char* fill_param, u32 sub_item_cnt);
			
//			S8Value* 			CreateS8		    (PropItemVec* items, const char* key, luabind::object object, const char* name);
//			S8Value* 			CreateS8		    (PropItemVec* items, const char* key, luabind::object object, const char* name, s8 mn);
//			S8Value* 			CreateS8		    (PropItemVec* items, const char* key, luabind::object object, const char* name, s8 mn, s8 mx);
//			S8Value* 			CreateS8		    (PropItemVec* items, const char* key, luabind::object object, const char* name, s8 mn, s8 mx, s8 inc);
			...
			VectorValue*  	 	CreateVector	    (PropItemVec* items, const char* key, luabind::object object, const char* name, float mn, float mx, float inc);
			VectorValue*  	 	CreateVector	    (PropItemVec* items, const char* key, luabind::object object, const char* name, float mn, float mx, float inc, int decim);
			...
			Flag8Value*			CreateFlag8		    (PropItemVec* items, const char* key, luabind::object object, const char* name, u8 mask, const char* c0, const char* c1);
			Flag8Value*			CreateFlag8		    (PropItemVec* items, const char* key, luabind::object object, const char* name, u8 mask, const char* c0, const char* c1, u32 flags);
			...
			Flag16Value*		CreateFlag16	    (PropItemVec* items, const char* key, luabind::object object, const char* name, u16 mask, const char* c0, const char* c1);
			Flag16Value*		CreateFlag16	    (PropItemVec* items, const char* key, luabind::object object, const char* name, u16 mask, const char* c0, const char* c1, u32 flags);
			...
			Flag32Value*		CreateFlag32	    (PropItemVec* items, const char* key, luabind::object object, const char* name, u32 mask, const char* c0, const char* c1);
			Flag32Value*		CreateFlag32	    (PropItemVec* items, const char* key, luabind::object object, const char* name, u32 mask, const char* c0, const char* c1, u32 flags);

			Token8Value*		CreateToken8	    (PropItemVec* items, const char* key, luabind::object object, const char* name, CScriptTokenList* token);
			Token16Value*		CreateToken16	    (PropItemVec* items, const char* key, luabind::object object, const char* name, CScriptTokenList* token);
			Token32Value*		CreateToken32	    (PropItemVec* items, const char* key, luabind::object object, const char* name, CScriptTokenList* token);
//			RToken8Value* 		CreateRToken8	    (PropItemVec* items, const char* key, luabind::object object, const char* name, RTokenVec* token);
//			RToken16Value* 		CreateRToken16	    (PropItemVec* items, const char* key, luabind::object object, const char* name, RTokenVec* token);
//			RToken32Value* 		CreateRToken32	    (PropItemVec* items, const char* key, luabind::object object, const char* name, RTokenVec* token);
//			TokenValueSH*   	CreateTokenSH	    (PropItemVec* items, const char* key, luabind::object object, const char* name, u32 cnt, const TokenValueSH::Item* lst);
			RListValue* 	 	CreateRList		    (PropItemVec* items, const char* key, luabind::object object, const char* name, CScriptRTokenList *tokens);
...
//			WaveValue* 			CreateWave		    (PropItemVec* items, const char* key, WaveForm* val);
			...
			FloatValue* 		CreateAngle		    (PropItemVec* items, const char* key, luabind::object object, const char* name, float mn, float mx, float inc);
			FloatValue* 		CreateAngle		    (PropItemVec* items, const char* key, luabind::object object, const char* name, float mn, float mx, float inc, int decim);
			...
			VectorValue* 		CreateAngle3	    (PropItemVec* items, const char* key, luabind::object object, const char* name, float mn, float mx, float inc);
			VectorValue* 		CreateAngle3	    (PropItemVec* items, const char* key, luabind::object object, const char* name, float mn, float mx, float inc, int decim);
//			RTextValue* 		CreateName		    (PropItemVec* items, const char* key, luabind::object object, const char* name, ListItem* owner);
//			RTextValue* 		CreateNameCB		(PropItemVec* items, const char* key, luabind::object object, const char* name, TOnDrawTextEvent=0, RTextValue::TOnBeforeEditEvent=0, RTextValue::TOnAfterEditEvent=0);
