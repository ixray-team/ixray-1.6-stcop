	...
	module(L)
		[
			...
			class_<CUIListWnd, CUIWindow>("CUIListWnd")
				...
				.def("SetScrollBarProfile", &CUIListWnd::SetScrollBarProfile)
				.def("ScrollBar", &CUIListWnd::ScrollBar)
				.def("ReinitScrollBar", &CUIListWnd::ReinitScrollBar)
				...
				.def("PrevItem", &CUIListWnd::PrevItem)
				.def("NextItem", &CUIListWnd::NextItem)
