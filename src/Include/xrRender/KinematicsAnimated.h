...
public:
	...
	virtual CBlend* PlayCycle		(const char*  N,  bool bMixIn=true, PlayCallback Callback=nullptr, void* CallbackParam=nullptr, u8 channel = 0) = 0;
	virtual CBlend* PlayCycle		(MotionID M, bool bMixIn=true, PlayCallback Callback=nullptr, void* CallbackParam=nullptr, u8 channel = 0) = 0;
	virtual CBlend* PlayCycle		(u16 partition, MotionID M, bool bMixIn=true, PlayCallback Callback=nullptr, void* CallbackParam=nullptr, u8 channel = 0) = 0;
	// fx'es
	...
	virtual CBlend* PlayFX_Safe		(const char*	 N, float power_scale) = 0;
