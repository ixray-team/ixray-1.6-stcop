...
export const mainSidebar: DefaultTheme.Sidebar = [
    ...
    items: [
      {
        ...
        items: [
          ...
          { text: 'Smart Cover', link: '/gameplay/general/smart-covers' },
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: 'Tiramisu Render',
        collapsed: false,
        items: [
          { text: 'Текущий статус', link: '/graphics/tiramisu-render/status' },
          { text: 'Как работает сейчас', link: '/graphics/tiramisu-render/current-implementation' },
          { text: 'Обзор прототипа', link: '/graphics/tiramisu-render/overview' },
          { text: 'Архитектура', link: '/graphics/tiramisu-render/architecture' },
          { text: 'Стиль C++ кода', link: '/graphics/tiramisu-render/code-style' },
          { text: 'Материалы', link: '/graphics/tiramisu-render/materials' },
          { text: 'Матрица возможностей R4', link: '/graphics/tiramisu-render/r4-feature-matrix' },
          { text: 'Representative scenes', link: '/graphics/tiramisu-render/representative-scenes' },
          { text: 'Roadmap', link: '/graphics/tiramisu-render/roadmap' },
        ],
      },
