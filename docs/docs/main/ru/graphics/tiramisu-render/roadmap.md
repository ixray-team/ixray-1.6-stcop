...
- [x] material GPU ABI v4 добавляет 64-байтные light/palette records,
...
- [x] Повторить RenderDoc smoke через `-renderdoc -rdbg` на Vulkan и D3D12, зафиксировать RenderDoc 1.45/API 1.7 и путь `.rdc`.
...
- [x] Shader foundation: G-buffer, Directional/Point/Spot Forward PBR
  ...
  компилируются в DXIL и SPIR-V; source tests фиксируют ABI v4, 160-byte draw
