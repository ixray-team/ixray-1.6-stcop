# Burer Telekinesis — mod_system_ixray.ltx
...
| `Tele_Max_Pickuped_Weapons` | int | 1 | Maximum number of firearms the burer can hold simultaneously |
...
| Parameter | Type | Default | Description |
|-----------|------|---------|-------------|
| `Tele_Time_To_Hold` | int (ms) | 10000 | Time an object is held in the air before being thrown |
| `Tele_Object_Min_Mass` | float | 1 | Minimum mass of an object eligible for telekinesis pickup |
