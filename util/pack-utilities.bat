...
"%ProgramFiles%"\7-Zip\7z.exe a -tzip "ixray-1.6-r%release%-utilities-x64-mixed-bin.zip" ^
    ...
    -xr!"*.pdb"
popd
move build\x64\Utilities-Windows\ixray-1.6-r%release%-utilities-x64-debug-bin.zip ^
...
"%ProgramFiles%"\7-Zip\7z.exe a -tzip "ixray-1.6-r%release%-utilities-x64-mixed-lib.zip" ^
    ...
    -xr!"*.idb"
popd
move build\x64\Utilities-Windows\ixray-1.6-r%release%-utilities-x64-debug-lib.zip ^
...
:: Pack symbols
pushd build\x64\Utilities-Windows
"%ProgramFiles%"\7-Zip\7z.exe a -tzip "ixray-1.6-r%release%-utilities-x64-debug-pdb.zip" ^
    "bin\Debug" ^
    -xr!"*.exe" ^
    -xr!"*.dll" ^
    -ir!"lib\Debug" ^
    -xr!"*.lib" ^
    -xr!"*.exp"
"%ProgramFiles%"\7-Zip\7z.exe a -tzip "ixray-1.6-r%release%-utilities-x64-mixed-pdb.zip" ^
    "bin\RelWithDebInfo" ^
    -xr!"*.exe" ^
    -xr!"*.dll" ^
    ...
    -xr!"*.exp"
popd
move build\x64\Utilities-Windows\ixray-1.6-r%release%-utilities-x64-debug-pdb.zip ^
    publish\ixray-1.6-r%release%-utilities-x64-debug-pdb.zip
move build\x64\Utilities-Windows\ixray-1.6-r%release%-utilities-x64-mixed-pdb.zip ^
    publish\ixray-1.6-r%release%-utilities-x64-mixed-pdb.zip
