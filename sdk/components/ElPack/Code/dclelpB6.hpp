...
#include <SysInit.hpp>
#include <ElReg.hpp>
#include <frmFormPers.hpp>
#include <MlCapProp.hpp>
#include <ElTBDsgn.hpp>
#include <frmSoundMap.hpp>
#include <ColorMapProp.hpp>
#include <frmItemsProp.hpp>
#include <frmItemCol.hpp>
#include <frmSectEdit.hpp>
#include <frmSectProp.hpp>
#include <frmStrPoolEdit.hpp>
#include <ElImageIndexProp.hpp>
#include <ColnProp.hpp>
#include <PgCtlProp.hpp>
#include <ElMenuDsgn.hpp>
#include <ElEBDsgn.hpp>
#include <TreeDsgn.hpp>
...
#include <ElHotKey.hpp>	// (elpackB6)
#include <ElClock.hpp>	// (elpackB6)
#include <ElCRC32.hpp>	// (elpackB6)
#include <ElInputDlg.hpp>	// (elpackB6)
...
#include <ElVerInfo.hpp>	// (elpackB6)
#include <ElShellUtils.hpp>	// (elpackB6)
#include <ElFolderDlg.hpp>	// (elpackB6)
#include <ToolWnds.hpp>	// (designide)
#include <ColnEdit.hpp>	// (designide)
#include <ElHTMLHint.hpp>	// (elpackB6)
// PRG_EXT: .bpl
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLELPB6)
