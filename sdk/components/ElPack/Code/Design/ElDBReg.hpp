...
// (DO NOT EDIT: machine generated header) 'ElDBReg.pas' rev: 34.00 (Windows)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_ELDBREG)
