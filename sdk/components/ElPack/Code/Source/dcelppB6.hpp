...
// (DO NOT EDIT: machine generated header) 'dcelppB6.pas' rev: 6.00
...
#include <ElTreePrinter.hpp>	// Pascal unit
#include <ElPrinter.hpp>	// Pascal unit
#include <ElPrinterPreview.hpp>	// Pascal unit
...
#include <ElShellCtl.hpp>	// Pascal unit
...
#include <ElProReg.hpp>	// Pascal unit
