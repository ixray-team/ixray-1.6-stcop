...
// (DO NOT EDIT: machine generated header) 'elpackB6.pas' rev: 6.00
...
#include <ElShutdownWatcher.hpp>	// Pascal unit
...
#include <ElOpts.hpp>	// Pascal unit
...
#include <ElHashList.hpp>	// Pascal unit
#include <ElMD5.hpp>	// Pascal unit
...
#include <ElHint.hpp>	// Pascal unit
