...
// (DO NOT EDIT: machine generated header) 'ElTrackBar.pas' rev: 34.00 (Windows)
...
protected:
	...
	virtual int __fastcall GetAutoThumbSize();
	...
	System::Types::TRect __fastcall CalcThumbRect();
...
public:
	...
	__fastcall virtual ~TElTrackBar();
