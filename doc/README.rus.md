...
| :--- | :--- | :--- | :--- | :--- |
| Зов Припяти | Игровая | Windows x64 | [Engine+Assets](https://github.com/ixray-team/ixray-1.6-stcop/releases/download/r1.3.3/ixray-1.6-r1.3.3-engine-x64-game.zip) | Готовая сборка движка для игроков или необходимая для выпуска модификаций. Архив содержит движок и ресурсы для запуска игры |
| Зов Припяти | Для разработки | Windows x64 | [Engine+Assets](https://github.com/ixray-team/ixray-1.6-stcop/releases/download/r1.3.3/ixray-1.6-r1.3.3-engine-x64-develop.zip) | Готовая сборка движка для разработчиков, необходимая для удобной разработки модификаций. Архив содержит движок и ресурсы для запуска игры |
