...
## Релиз 1.3.6 (Сентябрь 2026)

### Общие изменения

- Обновлены рабочие процессы GitHub Actions (@Drombeys)
- Обновлен веб-сайт (@Drombeys, @FFx0001, @MafiosiGhost)
- Обновлены корневые документы (@Drombeys)

### Движок

- Исправлено воспроизведение звука дождя (@Drombeys)
- Исправлена ошибка, приводящая к сбою Spawn Manager при пустом `inv_name` (@MiS)
- Исправлено выделение памяти для скриптовых эффекторов (@Shtrecker)

### Геймплей

- Исправлено переключение детекторов (@Shtrecker)

## Релиз 1.3.5 (Сентябрь 2026)

### Общее

- Добавлена альтернативная упаковка платформы при выпуске релиза (@Drombeys)
- Добавлена сборка публикации для Clear Sky, Shadow of Chernobyl и Call of Chernobyl в GitHub Actions (@Drombeys)
- Исправлена сборка в новейшей версии Visual Studio 2026 (@wh1t3lord, @Drombeys)
- Исправлены рабочие процессы GitHub Actions (@Drombeys, @mnelenpridumivat)
- Улучшена упаковка редактора для релизов (@Drombeys)
- Переработаны карточки модов на сайте (@GladiatorVS)
- Обновлены корневые документы (@Drombeys)
- Обновлён сайт (@Drombeys, @ForserX, @FFx0001, @mrGlock5 (Desert Cliff), @LostAlphaRus, @kola2451)

### Движок

- Добавлена проверка существования `ShellHolder` в методе `CScriptGameObject::set_const_force` (@Drombeys)
- Добавлено логирование отсутствующего пути (@Drombeys)
- Добавлены проверки существования объектов в экспортах скриптов (@ForserX)
- Добавлена проверка безопасности в метод `CStalkerMovementRestrictor::weight` (@St4lker0k765)
- Исправлен вылет после выхода из многопользовательской игры (@St4lker0k765)
- Исправлен вылет во время уничтожения объекта с `RayPick` (@ForserX)
- Исправлен вылет при запуске с флагом `-nosound` (@Drombeys)
- Исправлен вылет при сохранении, когда динамический рестриктор удаляется вместо деактивации (@mnelenpridumivat)
- Улучшены экспорты скриптов для мода `Five Nights at Sidorovich's` (@ForserX)
- Увеличены лимиты `GAMEMTL_STEPSOUND_SUBITEM_COUNT` (@Shtrecker)
- Увеличен лимит длины строк в скриптах свыше 256 символов (@mnelenpridumivat)
- Сделано создание и уничтожение `CPHJoint` потокобезопасным (@ForserX)
- Предотвращён возврат nullptr в скрипты (@Drombeys)

### Геймплей

- Добавлено поле выражения `fltPlayerHealthRegeneration` (@St4lker0k765)
- Добавлен флаг `sign_inverse` для информации о бустерах (@St4lker0k765)
- Добавлен многопользовательский режим «Точки захвата» (@VodkaNET)
- Исправлен метод прицеливания (@Shtrecker)
- Исправлены анимации движения при прицеливании (@Shtrecker)
- Исправлено прицеливание с активным детектором (@Shtrecker)
- Исправлена видимость костей патронов (@Shtrecker)
- Исправлена эффективность бустеров для защиты от радиации, пси-воздействий и химического заражения (@Shtrecker)
- Исправлено скрытие прицельной сетки (@Shtrecker)
- Исправлен детектор в действии с оружием (@Shtrecker)
- Исправлен пустой клик (@Shtrecker)
- Исправлена обработка пустых ссылок (@Shtrecker)
- Исправлено действие смены режима огня (@Shtrecker)
- Исправлена итерация режимов огня (@Shtrecker)
- Исправлена обработка ввода в режиме ImGui (@St4lker0k765)
- Исправлена эффективность бинтов (@St4lker0k765)
- Исправлена очистка HUD звуков (@ForserX)
- Исправлена разборка предметов (@Shtrecker)
- Исправлен звук стука магазина (@Shtrecker)
- Исправлена анимация осечки в `CWeaponBM16` (@Shtrecker)
- Исправлено действие перезарядки у NPC (@Shtrecker)
- Исправлен оригинальный вылет, связанный с поиском пути мутантов (@Drombeys, @vertver)
- Исправлен оригинальный баг с итератором ракет РПГ (@Drombeys)
- Исправлены позиции рук в прицеливание (@Shtrecker)
- Исправлено переключение слота после выкидывания оружия (@Shtrecker)
- Исправлено воспроизведение звуков для случайных анимаций (@Shtrecker)
- Исправлена видимость границ пятен (@St4lker0k765)
- Исправлены вылеты стационарных пулемётов (@St4lker0k765)
- Исправлено крепление фонарика после экипировки (@St4lker0k765)
- Исправлены опечатки в инициализации инерции (@St4lker0k765)
- Исправлена motion mark при устранении осечки (@Shtrecker)
- Исправлена обработка состояния улучшений у механиков (@St4lker0k765)
- Исправлены анимации камеры оружия (@Shtrecker)
- Исправлен быстрый удар оружием (@Shtrecker)
- Улучшен взрыв контактных гранат (@Shtrecker, @gunslingermod)
- Добавлено воспроизведение стереозвуков в мировом пространстве (@Shtrecker)

### Графика

- Исправлена отрисовка динамических объектов в редакторах (@ForserX)
- Исправлена реализация GTAO (@LVutner)
- Исправлен оригинальный случайный вылет, связанный с заменой скайбокса (@ForserX)
- Исправлены полосатые тени от источников света (@v2v3v4)
- Уменьшена максимальная дальность отрисовки травы (@Drombeys)

### Ресурсы

- Адаптирован интерфейс для Call of Chernobyl (@St4lker0k765)
- Добавлена функция `log` в скрипт `_g` в Call of Chernobyl (@Drombeys)
- Добавлена конфигурация fsgame для Call of Chernobyl (@St4lker0k765)
- Добавлены локализуемые строки для сохранений (@St4lker0k765)
- Добавлен отсутствующий скрипт `ffx_path_utils` (@Drombeys, @FFx0001)
- Добавлены отсутствующие текстуры (@Drombeys)
- Добавлены ресурсы от Call of Chernobyl 1.4.22 (@Drombeys)
- Добавлены ресурсы от Shadow of Chernobyl (@Drombeys)
- Удалены дубликаты в файлах локализации (@Drombeys)
- Удалены неиспользуемые файлы из gamedata (@Drombeys)
- Включена автоматическая регистрация новых XML-файлов в Shadow of Chernobyl (@St4lker0k765)
- Исправлены сломанные комментарии в ресурсах Shadow of Chernobyl (@St4lker0k765)
- Исправлены сломанные анимации оружия в Call of Chernobyl (@St4lker0k765)
- Исправлены сломанные XML в Call of Chernobyl (@St4lker0k765)
- Исправлен размер иконок патронов на широкоэкранных мониторах (@St4lker0k765)
- Исправлены сломанные модели зомбированных в Call of Chernobyl (@Drombeys, @St4lker0k765)
- Исправлен вылет при загрузке сохранения в Shadow of Chernobyl (@Drombeys, @morrazzzz)
- Исправлены дубликаты в локализации (@Drombeys)
- Исправлен некорректный синтаксис и строки в конфигах (@Drombeys, @Hrusteckiy, @vadvalskiy)
- Исправлено неверное приведение типов в `death_manager.script` (@St4lker0k765)
- Исправлена максимальная популярность отрядов в smart terrains (@Drombeys)
- Исправлены множественные ошибки скриптов в Call of Chernobyl (@Drombeys)
- Исправлены оригинальные ошибки интерфейса в Shadow of Chernobyl (@Hrusteckiy)
- Исправлена оригинальная ошибка спавна мутантов на базах сталкеров (@Drombeys, @Hozar_2002)
- Исправлены проблемы интерфейса и адаптировано для широкоэкранных мониторов в Shadow of Chernobyl (@St4lker0k765)
- Переименована папка конфигов в Shadow of Chernobyl (@Drombeys)
- Заменены C-стиль комментариев на Lua-стиль в скриптах и шейдерах (@Drombeys, @vadvalskiy)
- Синхронизирован Call of Chernobyl с базовыми ресурсами (@Drombeys)
- Синхронизированы шейдеры между геймдатами (@Drombeys)
- Разблокирован уникальный контент в Shadow of Chernobyl (@St4lker0k765)

### Инструментарий

- Исправлена опечатка в форме выбора редакторов (@TheParaziT)

## Релиз 1.3.4 (Апрель 2026)

### Общее

- Удалены CMake-пресеты для x86 (@Drombeys)
- Обновлены корневые документы (@Drombeys)
- Обновлён веб-сайт (@ForserX, @FFx0001, @SaloEater, @LostAlphaRus)

### Движок

- Исправлена загрузка локализованных сохранений (@Drombeys)
- Исправлен пропуск сообщений в логе (@ForserX)
- Исправлена утечка памяти в рендерах (@v2v3v4)
- Исправлен выход из метода при отсутствии модели (@Drombeys)
- Реализовано опциональное столкновение камеры с НПС (@Hozar_2002)
- Улучшена стабильность бэкенда пользовательского интерфейса (@mrGlock5, @Drombeys)

### Графика

- Исправлена работа ночного режима в 3D-прицелах (@Shtrecker)
- Добавлено управление яркостью прицела для 3D-прицелов (@Shtrecker)
- Исправлено восстановление карты нормалей и нормали terrain для PBR-шейдеров (@LVutner)
- Удалена опция TAA для рендеров D3D9 (@LVutner)

### Геймплей

- Добавлен `aiIgnoreActor` для мутантов (@v2v3v4)
- Добавлена проверка, что вызывающий жив ли объект (@Drombeys)
- Добавлены функции мода FNaS (@Emmis)
- Добавлена проверка загрузки игры для подсказок, чтобы предотвратить их отображение на экране (@Shtrecker)
- Добавлена валидация при построении пути (@ForserX, @FFx0001, @Drombeys)
- Экспериментально исправлена офлайн-симуляция Alife (@Drombeys)
- Исправлена видимость дополнений (@Shtrecker)
- Исправлена анимация прицеливания с детектором (@Shtrecker)
- Исправлен сдвиг съедобных предметов после использования (@Shtrecker)
- Исправлено зависание при неверных параметрах глушителя (@FFx0001, @v2v3v4)
- Исправлен вылет GOAP (@v2v3v4)
- Исправлена перезарядка подствольного гранатомёта (@Shtrecker)
- Исправлена паковщик гранат (@Drombeys)
- Исправлено мерцание HUD (@Shtrecker)
- Исправлена инерция (@Shtrecker)
- Исправлены известные проблемы с ногами от первого лица (@v2v3v4)
- Исправлен расчёт ёмкости магазина (@Shtrecker)
- Исправлена ёмкость магазина в режиме гранатомёта (@Shtrecker)
- Исправлен отсутствующий звук дыхания (@mrGlock5)
- Исправлено смешивание анимаций перезарядки (@Shtrecker)
- Исправлены звуки перезарядки в системе прицелов STCoP WP (@Shtrecker)
- Исправлено состояние бега во время перезарядки (@Shtrecker)
- Исправлена проблема с прочностью брони Сидоровича при попадании в момент ношения и продажи той же брони (@Shtrecker)
- Исправлены вертикальные полосы (@mrGlock5)
- Принудительный вылет при отсутствующем улучшении (@St4lker0k765)
- Скрыты индикаторы при полностью повёрнутом зуме (@Shtrecker)
- Улучшена и исправлена схема костей пуль (@Shtrecker)
- Восстановлена старая логика загрузки для системы костей боеприпасов (@Shtrecker)
