...
float4 main(p_smaa I) : SV_Target
{
    ...
    return float4(SMAAColorEdgeDetectionPS(I.texcoord, I.offset, s_image), 0.0f, 0.0f);
#else
    return float4(SMAALumaEdgeDetectionPS(I.texcoord, I.offset, s_image), 0.0f, 0.0f);
#endif
}
